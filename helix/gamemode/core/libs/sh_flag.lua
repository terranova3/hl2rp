...
do
	...
	ix.flag.Add("f", "Access to union approved goods (food and drink)", "Business")
	ix.flag.Add("F", "Access to non-approved goods (food and drink)", "Business")
	ix.flag.Add("R", "Access to alcoholic items", "Business")
	ix.flag.Add("M", "Access to bootleg alcoholic items", "Business")
	ix.flag.Add("E", "Access to meat items", "Business")
	ix.flag.Add("g", "Access to general goods", "Business")
	ix.flag.Add("G", "Access to contraband", "Business")
	ix.flag.Add("Z", "Access to high-end contraband (arms and armour)", "Business")
