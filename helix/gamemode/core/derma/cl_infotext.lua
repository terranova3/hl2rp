...
function PANEL:Init()
	...
	self.label:SetText("");
	self.label:SetFont("ixMediumLightFontSmaller")
...
function PANEL:Paint(w, h)
	if (self:GetPaintBackground()) then
		...
		derma.SkinFunc("PaintCategoryPanel", self, "", self:GetBackgroundColor())
...
function PANEL:SetInfoColor(color)
	if (color == "red") then
		self:SetBackgroundColor(Color(179, 46, 49, 220));
		self:SetIcon("icon16/exclamation.png");
	elseif (color == "orange") then
		self:SetBackgroundColor(Color(223, 154, 72, 220));
		self:SetIcon("icon16/error.png");
	elseif (color == "green") then
		self:SetBackgroundColor(Color(139, 215, 113, 220));
		self:SetIcon("icon16/tick.png");
	elseif (color == "blue") then
		self:SetBackgroundColor(Color(139, 174, 179, 220));
