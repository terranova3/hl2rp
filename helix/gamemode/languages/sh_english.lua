...
LANGUAGE = {
	...
	optObserverTeleportBack = "Observer - Return to previous location",
	optdObserverTeleportBack = "Returns you to the location that you entered observer mode.",
	optItemESP = "Observer - Show item ESP",
	optdItemESP = "Shows the names and locations of each item on the server.",
	optToggleAlert = "Request - Hear alerts on admin request",
	optdToggleAlert = "Toggles the sound that admin requests make.",
	optObserverESP = "Observer - Show admin ESP",
