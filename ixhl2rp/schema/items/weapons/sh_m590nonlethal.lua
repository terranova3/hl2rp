ITEM.name = "Non-Lethal Shotgun"
ITEM.description = "Pump action shotguns manufactured by O.F. Mossberg & Sons in a setup that prevents efficient loading of unauthorized lethal ammunition."
