...
function PANEL:Init()
	local info = self:Add("ixInfoText")
	info:SetText(L("Hover over the icon of an item to get more information about it."))
...
function PANEL:Init()
	...
	self.labelitem:SetFont("ixMediumLightFont")
	...
	self.labelitemdesc:SetFont("ixMediumLightFontSmaller")
	...
	self.labelitemreq:SetFont("ixMediumLightFontSmaller")
	...
	self.craftbutton:SetFont("ixMediumLightFontSmaller")
