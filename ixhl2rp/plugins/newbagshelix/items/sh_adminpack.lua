...
ITEM.name = "Trashcan of goodies"
ITEM.description = "Admin use only. For cleaning up and transfering items for characters. Spawnable only."
...
ITEM.isBag = true
ITEM.functions.View = {
	icon = "models/props_trainstation/trashcan_indoor001b.mdl",
...
-- This is what was going through my mind when I was doing all this dumb shit - Ayreborne.
-- https://youtu.be/Tyahtqdit7w?t=835