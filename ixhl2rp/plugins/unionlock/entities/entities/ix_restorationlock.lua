...
if (SERVER) then
	...
	function ENT:SpawnFunction(client, trace)
		...
		local entity = ents.Create("ix_restorationlock")
	...
	function ENT:Toggle(client)
		...
		if (character:GetInventory():HasItem("restoration_card") or character:IsCombine()) then
	...
	local color_purple = Color(199, 0, 255, 255)
